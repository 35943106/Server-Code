...
void ui_pancakesrep_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Panel12, 62);
    lv_obj_set_height(ui_Panel12, 217);
    lv_obj_set_x(ui_Panel12, -213);
    lv_obj_set_y(ui_Panel12, -176);
    ...
    lv_obj_set_style_transform_angle(ui_Panel12, 450, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_transform_angle(ui_Label17, -900, LV_PART_MAIN | LV_STATE_DEFAULT);
